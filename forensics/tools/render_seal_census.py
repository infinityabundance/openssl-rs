...
def main(argv: list[str]) -> int:
    ...
    if coverage is not None:
        ...
        L.append("`forensics/tools/court_coverage.py`. Every implemented export of a")
        L.append("completed stratum is in exactly one of the three sets. **`directly_courted`")
        ...
        L.append("are proofs of reference only. See `docs/DECISIONS.md` D199.")
        L.append("")
