...
| 7 | EVP framework | `in-progress` | 359 open obligation(s) of this stratum recorded in forensics/phase7-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase |
...
|---|---|---|---|
| libcrypto | 5896 | 1562 | 4334 |
| libssl | 603 | 0 | 603 |
| **total** | **6499** | **1562** | **4937** |
