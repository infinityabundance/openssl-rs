...
| 6 | OSSL_LIB_CTX + provider core | `in-progress` | 44 open obligation(s) of this stratum recorded in forensics/phase6-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase |
...
|---|---|---|---|
| libcrypto | 5896 | 1091 | 4805 |
| libssl | 603 | 0 | 603 |
| **total** | **6499** | **1091** | **5408** |
...
Of those, 2 have since been implemented by phase 6, which is where the obligation sits, so phase 4 does not count them as its own work: `BIO_new_from_core_bio`, `BIO_s_core`
