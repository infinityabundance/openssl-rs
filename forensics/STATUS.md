...
|---|---|---|---|
| libcrypto | 5896 | 3084 | 2812 |
| libssl | 603 | 0 | 603 |
| **total** | **6499** | **3084** | **3415** |

### Phase 10 obligation ledger

Generated by `forensics/tools/phase10_obligations.py`, which fails closed: an export the
ownership atlas assigns Phase 10, or that an earlier stratum
...
Hand-offs from phase 7 discharged by this stratum: `PEM_write_bio_PrivateKey_traditional`, `d2i_AutoPrivateKey`, `d2i_AutoPrivateKey_ex`, `d2i_PrivateKey`, `d2i_PrivateKey_ex`, `i2d_KeyParams`, `i2d_KeyParams_bio`, `i2d_PKCS8PrivateKey`, `i2d_PrivateKey`, `i2d_PublicKey`
