...
| 8 | Native cryptographic primitives | `in-progress` | 489 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase |
...
|---|---|---|---|
| libcrypto | 5896 | 2203 | 3693 |
| libssl | 603 | 0 | 603 |
| **total** | **6499** | **2203** | **4296** |
...
* authority exports in the Phase 9 working set: 76
* implemented: 54
* deferred to a later phase with a stated reason: 0
