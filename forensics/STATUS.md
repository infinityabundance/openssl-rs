...
| 8 | Native cryptographic primitives | `in-progress` | 525 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase |
...
|---|---|---|---|
| libcrypto | 5896 | 2076 | 3820 |
| libssl | 603 | 0 | 603 |
| **total** | **6499** | **2076** | **4423** |
...
* implemented: 706
* deferred to a later phase with a stated reason: 244
* open in this stratum: 0
