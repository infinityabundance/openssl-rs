...
| 7 | EVP framework | `in-progress` | 307 open obligation(s) of this stratum recorded in forensics/phase7-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase |
...
|---|---|---|---|
| libcrypto | 5896 | 1614 | 4282 |
| libssl | 603 | 0 | 603 |
| **total** | **6499** | **1614** | **4885** |
