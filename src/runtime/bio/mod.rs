...
/// `BIO_R_LOCAL_ADDR_NOT_AVAILABLE` — returned by the datagram-pair read and
/// write paths when the caller asks for the local address without having enabled
/// it.
pub const BIO_R_LOCAL_ADDR_NOT_AVAILABLE: c_int = 111;
