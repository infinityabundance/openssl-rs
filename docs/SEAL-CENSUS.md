...
| 7 | EVP framework | `in-progress` | 924 | 950 | 597 | 164 | 189 |
...
* state: `in-progress`
* blocking: 189 open obligation(s) of this stratum recorded in forensics/phase7-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 9 court(s), **1259** authority observation(s) over 9 transcript court(s).
