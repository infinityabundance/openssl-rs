...
| 9 | RAND / DRBG + entropy | `in-progress` | 25 | 93 | 25 | 0 | 68 |
...
Courts: `all pass`, 2 court(s), **490** authority observation(s) over 2 transcript court(s).
...
| 9 | 25 | 25 | 25 | 0 | 0 | 0 | 0 |
| **total** | **2122** | **2114** | **1830** | **284** | **8** | **0** | **0** |
