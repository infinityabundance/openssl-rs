...
| 8 | Native cryptographic primitives | `in-progress` | 759 | 786 | 656 | 1 | 129 |
...
* state: `in-progress`
* blocking: 129 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 9 court(s), **11958** authority observation(s) over 7 transcript court(s).
...
| 8 | 656 | 648 | 648 | 0 | 8 | 0 | 0 |
| 9 | 58 | 58 | 58 | 0 | 0 | 0 | 0 |
| **total** | **2573** | **2565** | **2285** | **280** | **8** | **0** | **0** |
