...
| 7 | EVP framework | `in-progress` | 924 | 950 | 629 | 164 | 157 |
...
* state: `in-progress`
* blocking: 157 open obligation(s) of this stratum recorded in forensics/phase7-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 10 court(s), **1787** authority observation(s) over 10 transcript court(s).
