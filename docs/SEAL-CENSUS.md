...
| 8 | Native cryptographic primitives | `in-progress` | 759 | 786 | 160 | 16 | 610 |
...
* state: `in-progress`
* blocking: 610 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 4 court(s), **629** authority observation(s) over 2 transcript court(s).
