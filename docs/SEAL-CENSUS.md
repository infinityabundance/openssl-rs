...
| 8 | Native cryptographic primitives | `in-progress` | 759 | 786 | 644 | 1 | 141 |
...
* state: `in-progress`
* blocking: 141 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 9 court(s), **11768** authority observation(s) over 7 transcript court(s).
...
| 8 | 644 | 636 | 636 | 0 | 8 | 0 | 0 |
| 9 | 58 | 58 | 58 | 0 | 0 | 0 | 0 |
| **total** | **2561** | **2553** | **2273** | **280** | **8** | **0** | **0** |
