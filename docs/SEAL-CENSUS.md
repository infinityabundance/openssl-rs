...
| 8 | Native cryptographic primitives | `in-progress` | 759 | 786 | 228 | 16 | 542 |
...
* state: `in-progress`
* blocking: 542 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 6 court(s), **7893** authority observation(s) over 4 transcript court(s).
...
| 8 | 228 | 220 | 220 | 0 | 8 | 0 | 0 |
| **total** | **2069** | **2061** | **1777** | **284** | **8** | **0** | **0** |
