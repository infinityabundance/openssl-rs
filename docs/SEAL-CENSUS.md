...
| 8 | Native cryptographic primitives | `in-progress` | 759 | 786 | 617 | 1 | 168 |
...
* state: `in-progress`
* blocking: 168 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 9 court(s), **11566** authority observation(s) over 7 transcript court(s).
...
| 8 | 617 | 609 | 609 | 0 | 8 | 0 | 0 |
| 9 | 58 | 58 | 58 | 0 | 0 | 0 | 0 |
| **total** | **2534** | **2526** | **2245** | **281** | **8** | **0** | **0** |
