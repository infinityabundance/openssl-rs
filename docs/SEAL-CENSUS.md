...
* state: `in-progress`
* blocking: 66 provider registration row(s) of this stratum are neither implemented nor handed to a later phase (forensics/atlas/provider-algorithms.json): ARGON2D, ARGON2I, ARGON2ID, EC, ML-DSA-44, ML-DSA-65...
...
Courts: `all pass`, 15 court(s), **13464** authority observation(s) over 13 transcript court(s).
