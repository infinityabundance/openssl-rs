...
| 10 | Key formats + PKCS + STORE | `in-progress` | 272 | 298 | 161 | 0 | 137 |
...
Courts: `all pass`, 4 court(s), **2062** authority observation(s) over 4 transcript court(s).
...
| 9 | 69 | 69 | 69 | 0 | 0 | 0 | 0 |
| 10 | 161 | 161 | 98 | 63 | 0 | 0 | 0 |
| **total** | **2884** | **2876** | **2547** | **329** | **8** | **0** | **0** |
