...
| 8 | Native cryptographic primitives | `in-progress` | 759 | 786 | 143 | 16 | 627 |
...
* state: `in-progress`
* blocking: 627 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 4 court(s), **576** authority observation(s) over 2 transcript court(s).
