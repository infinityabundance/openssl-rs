...
| 8 | Native cryptographic primitives | `in-progress` | 759 | 786 | 612 | 1 | 173 |
...
* state: `in-progress`
* blocking: 173 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 9 court(s), **11537** authority observation(s) over 7 transcript court(s).
...
| 8 | 612 | 604 | 604 | 0 | 8 | 0 | 0 |
| 9 | 58 | 58 | 58 | 0 | 0 | 0 | 0 |
| **total** | **2529** | **2521** | **2240** | **281** | **8** | **0** | **0** |
