...
| 7 | EVP framework | `in-progress` | 924 | 950 | 612 | 164 | 174 |
...
* state: `in-progress`
* blocking: 174 open obligation(s) of this stratum recorded in forensics/phase7-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 9 court(s), **1367** authority observation(s) over 9 transcript court(s).
