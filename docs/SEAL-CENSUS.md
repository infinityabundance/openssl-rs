...
| 8 | Native cryptographic primitives | `in-progress` | 759 | 786 | 327 | 7 | 452 |
...
* state: `in-progress`
* blocking: 452 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 6 court(s), **8765** authority observation(s) over 4 transcript court(s).
...
| 8 | 327 | 319 | 319 | 0 | 8 | 0 | 0 |
| 9 | 54 | 54 | 54 | 0 | 0 | 0 | 0 |
| **total** | **2240** | **2232** | **1951** | **281** | **8** | **0** | **0** |
