...
* state: `in-progress`
* blocking: 324 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 9 court(s), **9886** authority observation(s) over 7 transcript court(s).
