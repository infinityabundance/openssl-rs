...
| 9 | RAND / DRBG + entropy | `in-progress` | 25 | 93 | 38 | 0 | 55 |
...
Courts: `all pass`, 4 court(s), **705** authority observation(s) over 4 transcript court(s).
...
| 9 | 38 | 38 | 38 | 0 | 0 | 0 | 0 |
| **total** | **2135** | **2127** | **1843** | **284** | **8** | **0** | **0** |
