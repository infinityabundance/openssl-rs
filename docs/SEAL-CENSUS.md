...
| 10 | Key formats + PKCS + STORE | `in-progress` | 272 | 298 | 87 | 0 | 211 |
...
Courts: `all pass`, 2 court(s), **239** authority observation(s) over 2 transcript court(s).
...
| 9 | 69 | 69 | 69 | 0 | 0 | 0 | 0 |
| 10 | 87 | 87 | 8 | 79 | 0 | 0 | 0 |
| **total** | **2810** | **2802** | **2457** | **345** | **8** | **0** | **0** |
