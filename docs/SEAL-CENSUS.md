...
| 8 | Native cryptographic primitives | `in-progress` | 759 | 786 | 348 | 7 | 431 |
...
* state: `in-progress`
* blocking: 431 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 7 court(s), **8831** authority observation(s) over 5 transcript court(s).
...
| 8 | 348 | 340 | 340 | 0 | 8 | 0 | 0 |
| 9 | 54 | 54 | 54 | 0 | 0 | 0 | 0 |
| **total** | **2261** | **2253** | **1972** | **281** | **8** | **0** | **0** |
