...
| 8 | Native cryptographic primitives | `in-progress` | 759 | 786 | 293 | 7 | 486 |
...
* state: `in-progress`
* blocking: 486 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 6 court(s), **8531** authority observation(s) over 4 transcript court(s).
...
| 8 | 293 | 285 | 285 | 0 | 8 | 0 | 0 |
| 9 | 54 | 54 | 54 | 0 | 0 | 0 | 0 |
| **total** | **2206** | **2198** | **1917** | **281** | **8** | **0** | **0** |
