...
| 8 | Native cryptographic primitives | `in-progress` | 759 | 786 | 272 | 24 | 490 |
...
Courts: `all pass`, 6 court(s), **8217** authority observation(s) over 4 transcript court(s).
...
| 8 | 272 | 264 | 264 | 0 | 8 | 0 | 0 |
| 9 | 39 | 39 | 39 | 0 | 0 | 0 | 0 |
| **total** | **2170** | **2162** | **1879** | **283** | **8** | **0** | **0** |
