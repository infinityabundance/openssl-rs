...
| 7 | EVP framework | `in-progress` | 924 | 950 | 705 | 164 | 81 |
...
* state: `in-progress`
* blocking: 81 open obligation(s) of this stratum recorded in forensics/phase7-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 15 court(s), **2226** authority observation(s) over 15 transcript court(s).
