...
| 7 | EVP framework | `in-progress` | 924 | 950 | 11 | 0 | 939 |
...
* state: `in-progress`
* blocking: 939 open obligation(s) of this stratum recorded in forensics/phase7-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 1 court(s), **38** authority observation(s) over 1 transcript court(s).
