...
* implemented: 278
* deferred to a later stratum with a stated reason: 18
* **open in this stratum: 490**

Deferred out, by receiving stratum:

* to phase 9: 18 symbol(s)
...
Courts: `all pass`, 6 court(s), **8350** authority observation(s) over 4 transcript court(s).
