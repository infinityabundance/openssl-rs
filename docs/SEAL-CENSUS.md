...
| 7 | EVP framework | `in-progress` | 924 | 950 | 601 | 164 | 185 |
...
* state: `in-progress`
* blocking: 185 open obligation(s) of this stratum recorded in forensics/phase7-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
Courts: `all pass`, 9 court(s), **1283** authority observation(s) over 9 transcript court(s).
