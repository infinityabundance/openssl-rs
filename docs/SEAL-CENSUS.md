...
* state: `in-progress`
* blocking: Phase 8 courts not passing: ['CT-DIGEST']
...
Courts: `NOT ALL PASS`, 1 court(s), **0** authority observation(s) over 0 transcript court(s).
