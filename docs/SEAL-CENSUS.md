...
* state: `in-progress`
* blocking: 81 provider registration row(s) of this stratum are neither implemented nor handed to a later phase (forensics/atlas/provider-algorithms.json): ARGON2D, ARGON2I, ARGON2ID, EC, ECDSA, ECDSA-SHA1...
...
Courts: `all pass`, 15 court(s), **13357** authority observation(s) over 13 transcript court(s).
