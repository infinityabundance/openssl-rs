...
| 8 | Native cryptographic primitives | `in-progress` | 759 | 786 | 456 | 2 | 328 |
...
* state: `in-progress`
* blocking: 328 open obligation(s) of this stratum recorded in forensics/phase8-obligations.json; a stratum cannot be complete while any export it owns is neither implemented nor handed to a later phase
...
* to phase 9: 2 symbol(s)
  `DES_random_key`, `EC_KEY_generate_key`
...
Courts: `all pass`, 8 court(s), **9403** authority observation(s) over 6 transcript court(s).
...
| 8 | 456 | 448 | 448 | 0 | 8 | 0 | 0 |
| 9 | 54 | 54 | 54 | 0 | 0 | 0 | 0 |
| **total** | **2369** | **2361** | **2080** | **281** | **8** | **0** | **0** |
