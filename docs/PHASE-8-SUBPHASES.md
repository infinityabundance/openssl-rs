...
**Open exports (checked against the ledger):** `PEM_read_DSAPrivateKey`, `PEM_read_ECPrivateKey`,
`PEM_read_RSAPrivateKey`, `PEM_read_bio_DSAPrivateKey`, `PEM_read_bio_ECPrivateKey`,
