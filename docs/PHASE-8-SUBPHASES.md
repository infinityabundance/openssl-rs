...
key-wrap rows landed in D230, the six CBC-CTS rows in D231, the two AES-XTS rows in D232 and the
three AES-OCB rows in D233, leaving the CCM and SIV rows and ChaCha20 open; the AES-GCM rows are
