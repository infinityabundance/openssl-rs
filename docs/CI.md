...
numbers are a snapshot of it): 345 implemented `libcrypto` symbols, 109 open
Phase 4 obligations, 20 courts all passing, 4,486 observations.
...
`STATUS.md`) is regenerated by `forensics/tools/evidence_determinism.py` and
compared against the committed copy. If a committed artefact is stale relative to
